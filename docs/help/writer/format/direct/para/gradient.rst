...
There are many preset gradients available.
Using the :py:class:`~ooodev.format.writer.direct.para.area.PresetGradientKind` enum, you can set the gradient to one of the presets.
