...
class FormCtlFile(FormCtlBase, TextEvents, ResetEvents):
    """``com.sun.star.form.component.FileControl`` control"""
    ...
    def __init__(self, ctl: XControl, lo_inst: LoInst | None = None) -> None:
        ...
        Args:
            ctl (XControl): Control supporting ``com.sun.star.form.component.FileControl`` service.
    ...
    def get_form_component_kind(self) -> FormComponentKind:
        ...
        return FormComponentKind.FILE_CONTROL
