...
from ..form_ctl_numeric_field import FormCtlNumericField

if TYPE_CHECKING:
    from com.sun.star.form.component import DatabaseNumericField as ControlModel  # service
    from ooodev.events.args.listener_event_args import ListenerEventArgs
    from ooodev.utils.inst.lo.lo_inst import LoInst


class FormCtlDbNumericField(FormCtlNumericField, DataAwareControlModelPartial, UpdateEvents):
    """``com.sun.star.form.component.DatabaseNumericField`` control"""
    ...
    def __init__(self, ctl: XControl, lo_inst: LoInst | None = None) -> None:
        ...
        Args:
            ctl (XControl): Control supporting ``com.sun.star.form.component.DatabaseNumericField`` service.
        ...
        """
        FormCtlNumericField.__init__(self, ctl=ctl, lo_inst=lo_inst)
    ...
    def get_form_component_kind(self) -> FormComponentKind:
        ...
        return FormComponentKind.DATABASE_NUMERIC_FIELD
