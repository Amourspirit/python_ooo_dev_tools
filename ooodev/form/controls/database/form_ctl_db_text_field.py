...
from ..form_ctl_text_field import FormCtlTextField

if TYPE_CHECKING:
    from com.sun.star.form.component import DatabaseTextField as ControlModel  # service
    from ooodev.events.args.listener_event_args import ListenerEventArgs
    from ooodev.loader.inst.lo_inst import LoInst


class FormCtlDbTextField(FormCtlTextField, DataAwareControlModelPartial, UpdateEvents):
    """``com.sun.star.form.component.DatabaseTextField`` control"""
    ...
    def __init__(self, ctl: XControl, lo_inst: LoInst | None = None) -> None:
        ...
        Args:
            ctl (XControl): Control supporting ``com.sun.star.form.component.DatabaseTextField`` service.
        ...
        """
        FormCtlTextField.__init__(self, ctl=ctl, lo_inst=lo_inst)
    ...
    def get_form_component_kind(self) -> FormComponentKind:
        ...
        return FormComponentKind.DATABASE_TEXT_FIELD
