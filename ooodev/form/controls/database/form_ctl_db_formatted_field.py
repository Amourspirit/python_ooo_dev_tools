...
from ..form_ctl_formatted_field import FormCtlFormattedField

if TYPE_CHECKING:
    from com.sun.star.form.component import DatabaseFormattedField as ControlModel  # service
    from ooodev.events.args.listener_event_args import ListenerEventArgs
    from ooodev.utils.inst.lo.lo_inst import LoInst


class FormCtlDbFormattedField(FormCtlFormattedField, DataAwareControlModelPartial, UpdateEvents):
    ...
    def __init__(self, ctl: XControl, lo_inst: LoInst | None = None) -> None:
        ...
        Args:
            ctl (XControl): Control supporting ``com.sun.star.form.component.FormattedField`` service.
        ...
        """
        FormCtlFormattedField.__init__(self, ctl=ctl, lo_inst=lo_inst)
    ...
    def get_form_component_kind(self) -> FormComponentKind:
        ...
        return FormComponentKind.DATABASE_FORMATTED_FIELD
