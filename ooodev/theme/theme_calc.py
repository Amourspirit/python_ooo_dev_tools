...
class ThemeCalc(ThemeBase):
    ...
    @property
    def page_break_color(self) -> int:
        """Page Break color."""
        try:
            return self._page_break_color
        except AttributeError:
            self._page_break_color = self._get_color("CalcPageBreak")
        return self._page_break_color
    ...
    @property
    def text_overflow_color(self) -> int:
        """Text Overflow color."""
        try:
            return self._text_overflow_color
        except AttributeError:
            self._text_overflow_color = self._get_color("CalcTextOverflow")
        return self._text_overflow_color

    @property
    def text_overflow_visible(self) -> bool:
        """Text Overflow visible."""
        try:
            return self._text_overflow_visible
        except AttributeError:
            self._text_overflow_visible = self._get_visible("CalcTextOverflow")
        return self._text_overflow_visible
    ...
    def comments_color(self) -> int:
        """Comments color."""
        try:
            return self._comments_color
        except AttributeError:
            self._comments_color = self._get_color("CalcComments")
        return self._comments_color
