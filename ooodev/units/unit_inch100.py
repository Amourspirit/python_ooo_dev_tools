...
_TUnitInch100 = TypeVar("_TUnitInch100", bound="UnitInch100")
...
class UnitInch100(BaseFloatValue):
    ...
    # region Overrides
    def _from_float(self, value: float) -> UnitInch100:
        return self.from_inch100(value)
    ...
    def get_unit_length() -> UnitLength:
        ...
        Returns:
            UnitLength: Instance unit length ``UnitLength.IN100``.
        """
        return UnitLength.IN100
    ...
    def convert_to(self, unit: UnitLength) -> float:
        ...
        """
        return UnitConvert.convert(num=self.value, frm=UnitLength.IN100, to=unit)
    ...
    def get_value_app_font(self, kind: PointSizeKind | int) -> float:
        ...
        af = af_type.from_inch100(self.value)
        return af.value
    ...
    @classmethod
    def from_app_font(cls: Type[_TUnitInch100], value: float, kind: PointSizeKind | int) -> _TUnitInch100:
        """
        ...
        return cls.from_inch100(af.get_value_inch100())

    @classmethod
    def from_unit_val(cls: Type[_TUnitInch100], value: UnitT | float | int) -> _TUnitInch100:
        """
