...
class UnitAppFontHeight(UnitAppFontBase):
    """
    ...
    def _set_ratio(self) -> None:
        ...
        object.__setattr__(self, "_ratio", Lo.app_font_pixel_ratio.height)
    ...
    def get_value_oth_unit(self) -> float:
        ...
        ratio = Lo.app_font_pixel_ratio.width
    ...
    def get_app_font_kind(self) -> PointSizeKind:
        ...
        Returns:
            PointSizeKind: Returns ``PointSizeKind.HEIGHT``
        """
        return PointSizeKind.HEIGHT
