...
class UnitInch10(BaseFloatValue):
    ...
    def get_value_app_font(self, x: bool = True) -> float:
        ...
        if x:
            ...
            af = UnitAppFontX.from_inch10(self.value)
        else:
            from ooodev.units.unit_app_font_y import UnitAppFontY

            af = UnitAppFontY.from_inch10(self.value)
        return af.value
    ...
    @classmethod
    def from_app_font(cls: Type[_TUnitInch10], value: float, x: bool = True) -> _TUnitInch10:
        """
