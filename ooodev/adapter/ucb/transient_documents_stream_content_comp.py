...
if TYPE_CHECKING:
    from com.sun.star.ucb import TransientDocumentsStreamContent  # service
...
class _TransientDocumentsStreamContentComp(ComponentProp):
    ...
    def __init__(self, component: XContent) -> None:
        ...
        Args:
            component (XContent): UNO Component that supports ``com.sun.star.ucb.TransientDocumentsStreamContent`` service.
        """
...
class TransientDocumentsStreamContentComp(
    _TransientDocumentsStreamContentComp,
    ComponentPartial,
    ContentPartial,
    ...
    """
    Class for managing TransientDocumentsStreamContent Component.
    ...
    def __new__(cls, component: XContent, *args, **kwargs):
        ...
        clz = builder.get_class_type(
            name="ooodev.adapter.ucb.transient_documents_stream_content_comp.TransientDocumentsStreamContentComp",
        ...
        _TransientDocumentsStreamContentComp.__init__(result, component)
        return result
