...
class HomogenMatrixLine4StructComp(StructBase[HomogenMatrixLine4]):
    """
    HomogenMatrixLine4 Struct

    This class raises an event before and after a property is changed if it has been passed an event provider.

    The event raised before the property is changed is called ``com_sun_star_drawing_HomogenMatrixLine4_changing``.
    The event raised after the property is changed is called ``com_sun_star_drawing_HomogenMatrixLine4_changed``.
    ...
    def __init__(self, component: HomogenMatrixLine4, prop_name: str, event_provider: EventsT | None = None) -> None:
        """
        Constructor

        Args:
            component (HomogenMatrixLine4): Homogen Matrix Line.
    ...
    def _get_on_changing_event_name(self) -> str:
        return "com_sun_star_drawing_HomogenMatrixLine4_changing"

    def _get_on_changed_event_name(self) -> str:
        return "com_sun_star_drawing_HomogenMatrixLine4_changed"

    def _copy(self, src: HomogenMatrixLine4 | None = None) -> HomogenMatrixLine4:
        if src is None:
            src = self.component
    ...
    def column1(self) -> float:
        """
        Gets/Sets the number of Column1 in this HomogenMatrixLine4.
        """
    ...
    def column2(self) -> float:
        """
        Gets/Sets the number of Column2 in this HomogenMatrixLine4.
        """
    ...
    def column3(self) -> float:
        """
        Gets/Sets the number of Column3 in this HomogenMatrixLine4.
        """
    ...
    def column4(self) -> float:
        """
        Gets/Sets the number of Column4 in this HomogenMatrixLine4.
        """
