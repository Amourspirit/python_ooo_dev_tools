...
class FormatNamedEvent:
    ...
    """Style Modifing. Generally triggered when a style is calling ``_set()``, ``_remove()``, ``_update()``, ``_clear()``"""
    ...
    """Style Updating. Generall triggered when style is calling ``_update``"""
    STYLE_COPYING = "format_style_copying"
    """Style Copying. Generall triggered when style is calling ``copy``"""
    ...
    MULTI_STYLE_SET = "fomat_multi_style_set"
