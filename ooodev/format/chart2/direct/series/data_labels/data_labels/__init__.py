from ooo.dyn.i18n.number_format_index import (
    NumberFormatIndexEnum as NumberFormatIndexEnum,
)
...
from ooodev.format.inner.direct.chart2.series.data_labels.data_labels.text_attribs import (
    TextAttribs as TextAttribs,
)
...
from ooodev.format.inner.direct.chart2.series.data_labels.data_labels.orientation import (
