...
from ooodev.format.inner.direct.chart2.series.data_series.area.color import Color as Color
from ooodev.format.inner.direct.chart2.series.data_series.area.gradient import Gradient as Gradient
from ooodev.format.inner.direct.chart2.series.data_series.area.hatch import Hatch as Hatch
from ooodev.format.inner.direct.chart2.series.data_series.area.img import Img as Img
from ooodev.format.inner.direct.chart2.series.data_series.area.pattern import Pattern as Pattern
