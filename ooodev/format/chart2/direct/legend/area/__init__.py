...
from ooodev.format.inner.direct.chart2.legend.area.color import Color as Color
from ooodev.format.inner.direct.chart2.legend.area.gradient import Gradient as Gradient
from ooodev.format.inner.direct.chart2.legend.area.hatch import Hatch as Hatch
from ooodev.format.inner.direct.chart2.legend.area.img import Img as Img
from ooodev.format.inner.direct.chart2.legend.area.pattern import Pattern as Pattern
