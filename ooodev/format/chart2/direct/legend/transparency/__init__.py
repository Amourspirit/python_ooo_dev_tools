...
from ooodev.format.inner.direct.chart2.legend.transparent.transparency import (
    Transparency as Transparency,
)
from ooodev.format.inner.direct.chart2.legend.transparent.gradient import (
