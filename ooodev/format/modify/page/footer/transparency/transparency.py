...
class FooterTransparentTransparency(FillTransparency):
    """
    ...
    def _props(self) -> TransparentTransparencyProps:
        try:
            ...
            self._props_transparency = TransparentTransparencyProps(transparence="FooterFillTransparence")
        return self._props_transparency
...
class Transparency(PageStyleBaseMulti):
    ...
    def __init__(
        ...
        *,
        ...
        direct = FooterTransparentTransparency(value=value)
    ...
    def from_style(
        ...
        direct = FooterTransparentTransparency.from_obj(inst.get_style_props(doc))
    ...
    @property
    def prop_inner(self) -> FooterTransparentTransparency:
        """Gets Inner Transparency instance"""
        try:
            return self._direct_inner
        except AttributeError:
            self._direct_inner = cast(FooterTransparentTransparency, self._get_style_inst("direct"))
        return self._direct_inner
