...
class FooterTransparentGradient(FillGradient):
    """
...
class Gradient(PageStyleBaseMulti):
    ...
    def __init__(
        ...
        *,
        ...
        direct = FooterTransparentGradient(
            style=style,
            offset=offset,
            angle=angle,
            border=border,
    ...
    def from_style(
        ...
        direct = FooterTransparentGradient.from_obj(inst.get_style_props(doc))
    ...
    @property
    def prop_inner(self) -> FooterTransparentGradient:
        """Gets Inner Gradient instance"""
        try:
            return self._direct_inner
        except AttributeError:
            self._direct_inner = cast(FooterTransparentGradient, self._get_style_inst("direct"))
        return self._direct_inner
