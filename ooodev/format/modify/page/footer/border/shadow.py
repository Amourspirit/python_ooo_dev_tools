...
class FooterShadow(ShadowStruct):
...
class Shadow(PageStyleBaseMulti):
    ...
    def __init__(
        ...
        *,
        ...
        direct = FooterShadow(location=location, color=color, transparent=transparent, width=width)
        super().__init__()
    ...
    def from_style(
        ...
        direct = FooterShadow.from_obj(inst.get_style_props(doc))
    ...
    @property
    def prop_inner(self) -> FooterShadow:
        """Gets Inner Shadow instance"""
        try:
            return self._direct_inner
        except AttributeError:
            self._direct_inner = cast(FooterShadow, self._get_style_inst("direct"))
        return self._direct_inner
