...
from .....style.page.area.color import Color as Color
from .....style.page.area.gradient import Gradient as Gradient
from .....style.page.area.img import Img as Img
from .....style.page.area.pattern import Pattern as Pattern
from .....style.page.area.hatch import Hatch as Hatch
