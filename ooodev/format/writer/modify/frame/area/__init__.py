...
from ooodev.format.inner.common.format_types.offset_row import OffsetRow as OffsetwRow  # noqa # type: ignore
...
from ooodev.format.inner.direct.write.fill.area.fill_color import (
    FillColor as InnerColor,  # noqa # type: ignore
)
