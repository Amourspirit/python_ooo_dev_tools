...
from ooodev.format.inner.modify.write.page.footer.area.gradient import (
...
from ooodev.format.inner.modify.write.page.header.area.color import (
    InnerColor as InnerColor,
)
