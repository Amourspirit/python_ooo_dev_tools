...
from ooodev.format.inner.modify.write.page.footer.transparency.gradient import Gradient as Gradient
from ooodev.format.inner.modify.write.page.footer.transparency.transparency import Transparency as Transparency
