...
from ooodev.format.inner.modify.write.page.footer.border.padding import (
    Padding as Padding,
)
...
from ooodev.format.inner.modify.write.page.header.border.padding import (
    InnerPadding as InnerPadding,
)
from ooodev.format.inner.modify.write.page.header.border.shadow import (
    InnerShadow as InnerShadow,
)
from ooodev.format.inner.modify.write.page.header.border.sides import (
