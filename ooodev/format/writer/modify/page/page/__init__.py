...
from .....modify.page.page.margins import Margins as Margins
from .....modify.page.page.paper_format import PaperFormat as PaperFormat
from .....modify.page.page.layout_settings import LayoutSettings as LayoutSettings
