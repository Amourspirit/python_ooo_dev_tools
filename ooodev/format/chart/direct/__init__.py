...
from ooodev.format.inner.direct.chart.chart.borders.line_properties import LineProperties as LineProperties
...
__all__ = ["LineProperties", "Color", "Gradient", "Hatch", "Img", "Pattern"]
