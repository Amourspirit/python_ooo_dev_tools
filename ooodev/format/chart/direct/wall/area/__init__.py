...
from ooodev.format.inner.direct.chart.wall.area.color import Color as Color
from ooodev.format.inner.direct.chart.wall.area.gradient import Gradient as Gradient
from ooodev.format.inner.direct.chart.wall.area.hatch import Hatch as Hatch
from ooodev.format.inner.direct.chart.wall.area.img import Img as Img
from ooodev.format.inner.direct.chart.wall.area.pattern import Pattern as Pattern
