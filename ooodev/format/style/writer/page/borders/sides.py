...
class Sides(PageStyleBase, AbstractSides):
    """
    Page Style Border.
    ...
    @staticmethod
    def from_obj(obj: object, style_name: StylePageKind | str = StylePageKind.STANDARD) -> Sides:
        """
        ...
        """
        bc = Sides(style_name=style_name)
