...
class FillGradientT(StyleMultiT, Protocol):
    ...
    @classmethod
    def from_struct(cls, struct: GradientStruct, name: str = "", **kwargs) -> FillGradientT:
        """
    ...
    @overload
    @classmethod
    def from_preset(cls, preset: PresetGradientKind) -> FillGradientT: ...

    @overload
    @classmethod
    def from_preset(cls, preset: PresetGradientKind, **kwargs) -> FillGradientT: ...
