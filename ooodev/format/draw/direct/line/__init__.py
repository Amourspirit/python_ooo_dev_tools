...
from ooodev.format.inner.direct.write.shape.area.shadow import (
    ShadowLocationKind as ShadowLocationKind,
)
from ooodev.format.inner.preset.preset_border_line import (
    BorderLineKind as BorderLineKind,
)
from ooodev.utils.kind.graphic_arrow_style_kind import (
    GraphicArrowStyleKind as GraphicArrowStyleKind,
)
