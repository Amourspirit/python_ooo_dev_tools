...
from ooodev.format.inner.direct.calc.alignment.text_align import TextAlign as TextAlign
...
from ooodev.format.inner.direct.calc.alignment.text_orientation import TextOrientation as TextOrientation
