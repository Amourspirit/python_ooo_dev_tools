...
from ooodev.format.inner.modify.calc.page.page.margins import InnerMargins as InnerMargins
from ooodev.format.inner.modify.calc.page.page.margins import Margins as Margins
from ooodev.format.inner.modify.calc.page.page.paper_format import InnerPaperFormat as InnerPaperFormat
