...
from ooodev.format.inner.modify.calc.page.header.border.padding import (
    InnerPadding as InnerPadding,
)
from ooodev.format.inner.modify.calc.page.footer.border.padding import (
    Padding as Padding,
)
from ooodev.format.inner.modify.calc.page.header.border.sides import (
    InnerSides as InnerSides,
)
from ooodev.format.inner.modify.calc.page.footer.border.sides import Sides as Sides
from ooodev.format.inner.modify.calc.page.header.border.shadow import (
