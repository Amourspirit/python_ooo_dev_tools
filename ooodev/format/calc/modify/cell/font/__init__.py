...
from ooodev.format.inner.modify.calc.font.font_effects import (
    InnerFontEffects as InnerFontEffects,
)
from ooodev.format.inner.modify.calc.font.font_only import FontOnly as FontOnly
from ooodev.format.inner.modify.calc.font.font_only import (
    InnerFontOnly as InnerFontOnly,
)
