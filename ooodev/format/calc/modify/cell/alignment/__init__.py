...
from ooodev.format.inner.modify.calc.alignment.properties import InnerProperties as InnerProperties
from ooodev.format.inner.modify.calc.alignment.properties import Properties as Properties
from ooodev.format.inner.modify.calc.alignment.text_align import InnerTextAlign as InnerTextAlign
