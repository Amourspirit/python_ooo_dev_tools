...
class ModelFixedLine(ModelPropPartial, UnoControlFixedLineModelPartial, ModelDialogElementPartial):
    ...
    def __init__(self, model: UnoControlModel) -> None:
        ...
        UnoControlFixedLineModelPartial.__init__(self, self.model)
        ModelDialogElementPartial.__init__(self, self.model)

    def __repr__(self) -> str:
        if hasattr(self, "name"):
            return f"ModelFixedLine({self.name})"
        return "ModelFixedLine"
