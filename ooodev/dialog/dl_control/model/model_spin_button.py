...
class ModelSpinButton(ModelPropPartial, UnoControlSpinButtonModelPartial, ModelDialogElementPartial):
    ...
    def __init__(self, model: UnoControlModel) -> None:
        ...
        UnoControlSpinButtonModelPartial.__init__(self, self.model)
        ModelDialogElementPartial.__init__(self, self.model)

    def __repr__(self) -> str:
        if hasattr(self, "name"):
            return f"ModelSpinButton({self.name})"
        return "ModelSpinButton"
