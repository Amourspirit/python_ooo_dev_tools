...
class ModelGrid(ModelPropPartial, UnoControlGridModelPartial, ModelDialogElementPartial):
    ...
    def __init__(self, model: UnoControlModel) -> None:
        ...
        UnoControlGridModelPartial.__init__(self, self.model)
        ModelDialogElementPartial.__init__(self, self.model)

    def __repr__(self) -> str:
        if hasattr(self, "name"):
            return f"ModelGrid({self.name})"
        return "ModelGrid"
