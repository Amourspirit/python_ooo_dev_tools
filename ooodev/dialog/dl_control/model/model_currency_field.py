...
class ModelCurrencyField(ModelPropPartial, UnoControlCurrencyFieldModelPartial, ModelDialogElementPartial):
    ...
    def __repr__(self) -> str:
        if hasattr(self, "name"):
            return f"ModelCurrencyField({self.name})"
        return "ModelCurrencyField"
