...
class ModelListBox(ModelPropPartial, UnoControlListBoxModelPartial, UnoControlDialogElementPartial):
    ...
    def __init__(self, model: UnoControlModel) -> None:
        ...
        UnoControlListBoxModelPartial.__init__(self, self.model)
