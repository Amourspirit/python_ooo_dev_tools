...
class ModelPatternField(ModelPropPartial, UnoControlPatternFieldModelPartial, ModelDialogElementPartial):
    ...
    def __init__(self, model: UnoControlModel) -> None:
        ...
        UnoControlPatternFieldModelPartial.__init__(self, self.model)
        ModelDialogElementPartial.__init__(self, self.model)

    def __repr__(self) -> str:
        if hasattr(self, "name"):
            return f"ModelPatternField({self.name})"
        return "ModelPatternField"
