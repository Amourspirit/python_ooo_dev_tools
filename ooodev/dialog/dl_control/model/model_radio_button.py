...
class ModelRadioButton(ModelPropPartial, UnoControlRadioButtonModelPartial, ModelDialogElementPartial):
    ...
    def __init__(self, model: UnoControlModel) -> None:
        ...
        UnoControlRadioButtonModelPartial.__init__(self, self.model)
        ModelDialogElementPartial.__init__(self, self.model)

    def __repr__(self) -> str:
        if hasattr(self, "name"):
            return f"ModelRadioButton({self.name})"
