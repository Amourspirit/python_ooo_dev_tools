...
class ModelFixedText(ModelPropPartial, UnoControlFixedTextModelPartial, ModelDialogElementPartial):
    ...
    def __init__(self, model: UnoControlModel) -> None:
        ...
        UnoControlFixedTextModelPartial.__init__(self, self.model)
        ModelDialogElementPartial.__init__(self, self.model)

    def __repr__(self) -> str:
        if hasattr(self, "name"):
            return f"ModelFixedText({self.name})"
        return "ModelFixedText"
