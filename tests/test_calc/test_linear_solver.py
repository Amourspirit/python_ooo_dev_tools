...
def test_linear_solver(loader, capsys: pytest.CaptureFixture) -> None:
    ...
    assert "com.sun.star.comp.Calc.CoinMPSolver" in lst_result
    ...
    solver = Lo.create_instance_mcf(XSolver, "com.sun.star.comp.Calc.CoinMPSolver")
    solver.Document = doc
    ...
    assert len(lst_result) == 6
    assert lst_result[1] == 'B3 == 6315.6250'
    assert lst_result[3] == 'B1 == 21.8750'
    assert lst_result[4] == 'B2 == 53.1250'
