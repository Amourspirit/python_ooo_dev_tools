...
def test_scenarios(loader) -> None:
    ...
    try:
        ...
        Calc.insert_scenario(sheet=sheet, range_name="B10:C11", vals=vals, name="First Scenario", comment="1st scenario.")
        ...
        vals[1][0] = 23
        vals[1][1] = 24
        Calc.insert_scenario(sheet=sheet, range_name="B10:C11", vals=vals, name="Second Scenario", comment="Visible scenario.")
        Lo.delay(delay)
        ...
        Calc.insert_scenario(sheet=sheet, range_name="B10:C11", vals=vals, name="Third Scenario", comment="Last scenario.")
