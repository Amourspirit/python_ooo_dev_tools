...
from ooodev.format.writer.modify.page.footer.borders import Padding, WriterStylePageKind
...
def test_write(loader, para_text) -> None:
    ...
    try:
        ...
        assert props.getPropertyValue("FooterLeftBorderDistance") in range(border - 2, border + 3)
