...
def test_write(loader, para_text) -> None:
    ...
    try:
        ...
        assert f_style.prop_inner.prop_left.value == pytest.approx(amt, rel=1e2)
        assert f_style.prop_inner.prop_right.value == pytest.approx(amt, rel=1e2)
        assert f_style.prop_inner.prop_top.value == pytest.approx(amt, rel=1e2)
        assert f_style.prop_inner.prop_bottom.value == pytest.approx(amt, rel=1e2)
