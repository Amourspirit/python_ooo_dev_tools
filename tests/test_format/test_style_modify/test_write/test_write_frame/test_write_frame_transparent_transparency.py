...
import uno
from ooodev.format.writer.modify.frame.transparency import StyleFrameKind, Transparency, InnerTransparency, Intensity
...
def test_write(loader, para_text) -> None:
    ...
    try:
        ...
        style = style = Transparency(value=Intensity(52), style_name=StyleFrameKind.FRAME)
        color_style = Color(
        ...
        inner = InnerTransparency(value=Intensity(35))
