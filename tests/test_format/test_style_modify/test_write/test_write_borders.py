...
import uno
from ooodev.format.writer.modify.page.borders import Borders, Side, StylePageKind, BorderLineStyleEnum
...
def test_write(loader, para_text) -> None:
    ...
    try:
        ...
        border = Borders(border_side=Side(line=BorderLineStyleEnum.DOUBLE, color=CommonColor.DARK_RED))
        border.apply(doc)
