...
def test_calc(loader) -> None:
    ...
    try:
        ...
        style = Color(color=StandardColor.BLUE_LIGHT2, style_name=CalcStylePageKind.DEFAULT)
        style.apply(doc)
        props = style.get_style_props(doc)

        assert props.getPropertyValue(style.prop_inner._props.color) == StandardColor.BLUE_LIGHT2
