...
def test_draw(loader) -> None:
    ...
    try:
        ...
        assert f_style.prop_inner.prop_above is not None
        assert f_style.prop_inner.prop_above.get_value_mm100() in [500 - 2 + i for i in range(5)]
        assert f_style.prop_inner.prop_below is not None
        assert f_style.prop_inner.prop_below.get_value_mm100() in [550 - 2 + i for i in range(5)]
