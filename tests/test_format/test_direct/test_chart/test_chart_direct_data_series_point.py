...
from ooodev.format.chart.direct.series.area import Color as SeriesAreaColor
from ooodev.format.chart.direct.series.area import Gradient as SeriesAreaGradient, PresetGradientKind
from ooodev.format.chart.direct.series.area import Hatch as SeriesAreaHatch, PresetHatchKind
from ooodev.format.chart.direct.series.area import Img as SeriesAreaImg, PresetImageKind
from ooodev.format.chart.direct.series.area import Pattern as SeriesAreaPattern, PresetPatternKind

from ooodev.format.chart.direct.series.borders import LineProperties as SeriesBorderLineProperties, BorderLineKind

from ooodev.format.chart.direct.series.transparency import Transparency as SeriesTransparency
from ooodev.format.chart.direct.series.transparency import (
