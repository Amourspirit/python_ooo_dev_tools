...
def test_extract_pay(fix_xml_path, copy_fix_xml, tmp_path_session) -> None:
    xml_path: Path = copy_fix_xml("pay.xml")
    xdoc = XML.load_doc(str(xml_path))
    out_fnm = "pay.xml.txt"
    out_path = Path(tmp_path_session, out_fnm)
    sw = io.StringIO()
...
def test_extract_clubs(fix_xml_path, copy_fix_xml, tmp_path_session) -> None:
...
def test_extract_weather(fix_xml_path, copy_fix_xml, tmp_path_session) -> None:
...
def test_extract_company(fix_xml_path, copy_fix_xml, tmp_path_session) -> None:
