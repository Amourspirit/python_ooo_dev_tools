...
from ooodev.units import UnitInch10
...
def test_mul_inch() -> None:
    ...
    u2 = UnitInch10(100)
    u3 = u1 * u2
    assert u3.almost_equal(25.4)


def test_mul_px() -> None:
    u1 = UnitInch(2.54)
    u2 = UnitMM.from_inch(2)
    u3 = u1 * u2
    assert u3.almost_equal(5.08)
...
def test_div_inch() -> None:
    u1 = UnitInch.from_inch(4)  # 5080 mm 100
    u2 = UnitInch10(2)  # 5080 mm 100
    u3 = u1 / u2
    assert u3 == 20.0

    u1 = UnitInch.from_inch(10)  # 5080 mm 100
    u2 = UnitInch10(3)  # 5080 mm 100
    u3 = u1 / u2
    assert u3 == 33.33333333333333
