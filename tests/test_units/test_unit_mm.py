...
def test_mul_inch() -> None:
    ...
    u2 = UnitInch(2)  # 5080 mm 100, 50.8 mm
    u3 = u1 * u2
    # 2.45 = 254 in mm 100ths
    # 2 inches is 5080 mm 100ths
    # 254 * 5080 = 1290320
    # 1290320 / 10000 = 129.032
    # 2.54 * 50.8 = 129.032
    # 12903.2
    # 129.032
    assert u3.almost_equal(129.032)
...
def test_div_inch() -> None:
    u1 = UnitMM.from_inch(4)  # 5080 mm 100
    u2 = UnitInch(2)  # 5080 mm 100
    u3 = u1 / u2
    assert u3 == 2.0

    u1 = UnitMM.from_inch(10)  # 5080 mm 100
...
def test_plus_equals() -> None:
    u1 = UnitMM(2)
    u1 += 3
    assert isinstance(u1, UnitMM)
    assert u1 == 5
    u2 = UnitInch.from_mm(2)
    u1 += u2
    assert isinstance(u1, UnitMM)
    assert u1 == 7
